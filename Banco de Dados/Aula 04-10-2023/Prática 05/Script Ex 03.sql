...
SELECT * FROM Funcionario JOIN Acompanhante ON idFuncionario = fkFuncionario WHERE idFuncionario = 2;
SELECT * FROM Setor JOIN Funcionario JOIN Acompanhante ON idSetor = fkSetor and idFuncionario = fkFuncionario;
